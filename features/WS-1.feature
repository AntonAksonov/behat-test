...
Scenario: Validate the menu "Homme" and the sublinks
    ...
    And the return code of URL from attribute href of object Main.SubMenu_Men.Links should be equal to 200 (For all links)
...
Scenario: Validate the menu "Femme" and the sublinks
    ...
    And the return code of URL from attribute href of object Main.SubMenu_Women.Links should be equal to 200 (For all links)
...
Scenario: Validate the menu "Collections" and the sublinks
    ...
    And the return code of URL from attribute href of object Main.SubMenu_Collection.Links should be equal to 200 (For all links)

Scenario: Validate the menu "Univers Tissot"
    When the user navigates to {https://www.tissotwatches.com/}
    Then the object Main.Menu_Brand should be visible
    And the return code of URL from attribute href of object Main.Menu_Brand should be equal to 200

Scenario: Validate the menu "Service Client"
    When the user navigates to {https://www.tissotwatches.com/}
    Then the object Main.Menu_CustomerService should be visible
    And the return code of URL from attribute href of object Main.Menu_CustomerService should be equal to 200
...
Scenario: Validate the menu "Selection Pays" and the sublinks
    ...
    And the return code of URL from attribute href of object Main.Popup_CountrySelection.Links should be equal to 200 (For all links)
...
Scenario: Validate the menu "Store Locator"
    ...
    And the return code of URL from attribute href of object Main.Menu_StoreLocator should be equal to 200

Scenario: Validate the menu "Enregistrer Montre"
    When the user navigates to {https://www.tissotwatches.com/}
    Then the object Main.Menu_RegisterWatch should be visible
    And the return code of URL from attribute href of object Main.Menu_RegisterWatch should be equal to 200

Scenario: Validate the menu "Mon Compte"
    When the user navigates to {https://www.tissotwatches.com/}
    Then the object Main.Menu_MyAccount should be visible
    And the return code of URL from attribute href of object Main.Menu_MyAccount should be equal to 200

Scenario: Validate the menu "Mon Panier"
    When the user navigates to {https://www.tissotwatches.com/}
    Then the object Main.Menu_MyCart should be visible
    And the return code of URL from attribute href of object Main.Menu_MyCart should be equal to 200

Scenario: Validate the "Tissot Logo"
    When the user navigates to {https://www.tissotwatches.com/}
    Then the object Main.TissotLogo should be visible
    And the value of attribute href of object Main.TissotLogo should be equal to {https://www.tissotwatches.com/}
