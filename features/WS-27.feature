...
Scenario Outline: Validate the Product Detail content page
    ...
    And the return code of URL from attribute src of object ProductDetail.MainImage should be equal to 200
    And the object ProductDetail.Bullets should be visible
    And the return code of URL from attribute src of object ProductDetail.Images should be equal to 200 {{AllObjects}}
    And the return code of URL from attribute href of object ProductDetail.ImageLinks should be equal to 200 {{AllObjects}}
    And the object ProductDetail.Price should be visible
    And the object ProductDetail.SelectSize should be visible
    And the content of object ProductDetail.SelectSize should be not equal to []
    And the return code of URL from attribute href of object ProductDetail.SelectSize.Documentation should be equal to 200
    And the object ProductDetail.AddToCart should be visible
    And the object ProductDetail.ReserveInStore should be visible
    And the return code of URL from attribute href of object ProductDetail.ReserveInStore.Help should be equal to 200
